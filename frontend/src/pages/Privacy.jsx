  ...
  return (
    <div className="privacy_policy">
      ...
      <div className="privacy_policy_content">
        <h2>Privacy Policy for ziadentalcare</h2>
        <p>
          At ziadentalcare, accessible from
          <a href="https://ziadentalcare.pk/"> https://ziadentalcare.pk/</a>,
          one of our main priorities is the privacy of our visitors. This
          Privacy Policy document contains types of information that is
          collected and recorded by ziadentalcare and how we use it. If you have
        ...
        <p>
          ...
          expand our webste Understand and analyze how you use our webste
        ...
        <h2>Log Files</h2>
        <p>
          ziadentalcare follows a standard procedure of using log files. These
        ...
        <p>
          Like any other website, ziadentalcare uses ‘cookies’. These cookies
        ...
        <p>
          ...
          advertising partners of ziadentalcare. Third-party ad servers or ad
          ...
          on ziadentalcare, which are sent directly to users’ browser. They
          automatically receive your IP address when this occurs. These
          technologies are used to measure the effectiveness of their
          advertising campaigns and/or to personalize the advertising content
          that you see on websites that you visit. Note that ziadentalcare has
          no access to or control over these cookies that are used by
          third-party advertisers
        </p>
        <h2>Third Party Privacy Policies</h2>
        <p>
          ziadentalcare’s Privacy Policy does not apply to other advertisers or
        ...
        <p>
          ...
          ziadentalcare does not knowingly collect any Personal Identifiable
